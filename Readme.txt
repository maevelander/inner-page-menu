...
Simply activate the plugin, then add `<?php inner_page_menu(); ?>` in your theme page or sidebar template where you want the inner menus to appear.
...
1. Add `<?php inner_page_menu(); ?>` in your theme page or sidebar template where you want the inner menus to appear.
